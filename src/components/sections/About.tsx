...
const textStyles = 'max-w-md text-muted-foreground'
...
export default function About() {
  ...
  return (
    <section
      id='about'
      className='scroll-mt-14 px-4 md:px-10 py-20 max-w-5xl mx-auto flex flex-col items-center md:items-start'
    >
      ...
      >
        ...
        <div className='w-full flex'>
          <CollapsibleTrigger className='mt-2 font-semibold text-sm cursor-pointer text-accent'>
